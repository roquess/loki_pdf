 ...
 */
export function compression_level_from_string(level) {
    const ptr0 = passStringToWasm0(level, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.compression_level_from_string(ptr0, len0);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function extract_images(pdf_data) {
    const ptr0 = passArray8ToWasm0(pdf_data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.extract_images(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
 ...
 * @returns {any}
 */
export function get_pdf_info(pdf_data) {
    const ptr0 = passArray8ToWasm0(pdf_data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @param {Uint8Array} pdf_data
 * @param {any} compressed_images
 * @returns {Uint8Array}
 */
export function reinject_images(pdf_data, compressed_images) {
    const ptr0 = passArray8ToWasm0(pdf_data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.reinject_images(ptr0, len0, compressed_images);
    if (ret[3]) {
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_871c4d3788ea96a1 = function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('loki_pdf_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
